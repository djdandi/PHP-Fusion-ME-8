...
define ("DB_FOUNDRYMENU", DB_PREFIX."foundry_menu");
...
} // Recursive Hierarchy for Megamenu System ## Searchbox Error Unsolved
function megamenu() {
global $aidlink, $locale, $settings, $main_style;
	
add_to_head("<link rel='stylesheet' type='text/css' href='".THEME."megamenu.css'/>");
